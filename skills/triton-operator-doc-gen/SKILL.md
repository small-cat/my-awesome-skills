---
name: triton-npu-operator-doc-gen
description: 生成昇腾NPU的Triton算子接口文档。当用户需要为昇腾NPU的Triton算子创建或更新接口文档时使用。核心能力：(1)根据模板生成标准化文档 (2)支持昇腾NPU产品型号列表 (3)提供算子参数说明规范 (4)生成调用示例框架。
---
